...
// Declare global require for TypeScript
declare const require: (modules: string[], callback?: Function) => void;
...
function (Bootstrap: any, ko: any, app: any, Logger: any) { // this callback gets executed when all required modules are loaded
  Bootstrap.whenDocumentReady().then(
    function() {
      function init(): void {
        ...
        if (globalBody) {
          ko.applyBindings(app, globalBody);
        }
      }
